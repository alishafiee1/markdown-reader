...
فرض کن یادداشت‌ها و آموزش‌هایت پراکنده در پوشه‌های مارک‌داون است. می‌خواهی شب با موبایل یا روز با لپ‌تاپ همان‌ها را بخوانی، بدون باز کردن VS Code، بدون نصب ماژول داخل سایت دیگر. فقط یک آدرس: `http://سرور:4002`.
...
افزونه‌های بعدی (پیشرفت، تگ، یادداشت، گراف، بکاپ) — [`change/bookshelf-extensions/proposal.md`](change/bookshelf-extensions/proposal.md)
...
| [`change/bookshelf-extensions/`](change/bookshelf-extensions/proposal.md) | افزونه‌های بعدی: پیشرفت، تگ، یادداشت، گراف، بکاپ |
